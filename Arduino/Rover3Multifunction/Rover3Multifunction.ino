...
void writeStatus() {
  ...
  String logMessage = new String().concat(gps_latitude)
    .concat(gps_longitude).concat(" ")
    .concat(gps.f_altitude()).concat(" ")
    .concat(gps.f_course()).concat(" ")
    .concat(compass_heading).concat(" ")
    .concat(gps.f_speed_kmph()).concat(" ")
    .concat(year).concat(" ")
    .concat(month).concat(" ")
    .concat(day).concat(" ")
    .concat(hour).concat(" ")
    .concat(minute).concat(" ")
    .concat(second).concat(" ")
    .concat(temperature_dht22).concat(" ")
    .concat(humidity_dht22).concat(" ")
    .concat(compass_pitch).concat(" ")
    .concat(compass_roll).concat(" ")
    .concat(fwd_range_cm).concat(" ")
    .concat(rear_range_cm).concat(" ")
    .concat(XbeeDataReceivedString).concat(" ")
    .concat(XbeeDataSentString).concat(" ")
    .concat(otherData);
